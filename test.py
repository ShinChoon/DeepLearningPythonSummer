...
i_f_map = ((image_scale, image_scale, CHNL1, CHNLIn),  # same
           (28, 28, CHNL1, CHNL1),  # Pool
           (14, 14, CHNL2, CHNL1),  # full
           (16, 16, CHNL2, CHNL2),  # Pool
           (8, 8, CHNL3, CHNL2),  # Same
           (10, 10, CHNL3, CHNL3),  # Pool
           (5, 5, CHNL4, CHNL3),  # MLP1
           (4, 4, CHNL5, CHNL4),  # MLP2
           (144, 10)  # 7 * 7 * 6
           )
...
def create_and_test():
    ...
    MLP1 = FullyConnectedLayer(n_in=(i_f_map[6][2], i_f_map[6][0],
                                     i_f_map[6][1]), n_out=i_f_map[7][2]*i_f_map[7][1]*i_f_map[7][0],
                               activation_fn=ReLU, p_dropout=0.5)

    MLP2 = FullyConnectedLayer(n_in=(i_f_map[7][2], i_f_map[7][0],
                                     i_f_map[7][1]), n_out=i_f_map[8][0]*1*1,
                               activation_fn=ReLU, p_dropout=0.5)

    SMLayer = SoftmaxLayer(n_in=i_f_map[8][0],
                           n_out=i_f_map[8][1])
